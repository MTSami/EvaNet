...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', default = 194 , type = int, help = "No. of epochs to train model")
    parser.add_argument('--val_freq', default = 1 , type = int, help = "No. times to run evaluation during training")
